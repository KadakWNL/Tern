...
subject_label = ctk.CTkLabel(frame_right, text="Subject:", font=("Arial", 18))
subject_label.grid(row=3, column=0, padx=20, pady=(10, 10), sticky="w")
subject_entry_combobox = ctk.CTkComboBox(frame_right, values=["Phyiscs", "Mathematics", "Chemistry"], variable=subject_entry_variable, font=("Arial", 15), state="readonly")
